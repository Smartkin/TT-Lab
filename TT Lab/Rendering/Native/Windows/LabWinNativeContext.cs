...
namespace TT_Lab.Rendering.Native.Windows;

// This was written with ChatGPT assistance because working with WinAPI is a death sentence
public unsafe class LabWinNativeContext : IGlContext
{
    ...
    public LabWinNativeContext()
    {
        ...
        const string functionName = "wglCreateContextAttribsARB";
